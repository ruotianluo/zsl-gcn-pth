...
parser.add_argument('--pretrained_weight', dest='pretrained_weight', type=str,
                    help='use pre-trained model')
...
parser.add_argument('--out_feat_dir', default='feats', type=str,
                    help='The saved output feats')
...
def main():
    ...
    if args.arch.startswith('resnet'):
        ...
        # output both activation and logits
        del model.fc
        import types
